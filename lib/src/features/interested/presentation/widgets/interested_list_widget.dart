...
import 'package:dating/src/features/interested/presentation/helper/interested_helper.dart';
...
class _GenderListWidgetState extends State<InterestedList> {
  @override
  void initState() {
    super.initState();
    _loadGenres();
  ...
  void _markSelection(GenderModel model, List<GenderModel> _list) {
    setState(() {
      InterestedHelper.markSelection(model, _list);
    });
  }
}
